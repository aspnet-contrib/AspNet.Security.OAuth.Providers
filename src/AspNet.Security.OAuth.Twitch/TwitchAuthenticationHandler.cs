...
namespace AspNet.Security.OAuth.Twitch {
    ...
    public class TwitchAuthenticationHandler : OAuthAuthenticationHandler<TwitchAuthenticationOptions> {
        ...
        protected override async Task<AuthenticationTicket> CreateTicketAsync([NotNull] ClaimsIdentity identity,
            ...
            identity.AddOptionalClaim(ClaimTypes.NameIdentifier, TwitchAuthenticationHelper.GetIdentifier(payload), Options.ClaimsIssuer)
                    .AddOptionalClaim(ClaimTypes.Name, TwitchAuthenticationHelper.GetLogin(payload), Options.ClaimsIssuer)
                    .AddOptionalClaim("urn:Twitch:name", TwitchAuthenticationHelper.GetName(payload), Options.ClaimsIssuer);
