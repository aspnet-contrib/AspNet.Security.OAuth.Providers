...
namespace AspNet.Security.OAuth.Twitch {
    ...
    public class TwitchAuthenticationMiddleware : OAuthAuthenticationMiddleware<TwitchAuthenticationOptions> {
        ...
        public TwitchAuthenticationMiddleware(
            ...
            ConfigureOptions<TwitchAuthenticationOptions> configureOptions = null)
