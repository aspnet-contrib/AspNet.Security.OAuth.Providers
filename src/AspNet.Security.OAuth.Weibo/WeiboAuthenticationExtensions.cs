...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    {
        /// <summary>
        /// Adds the <see cref="WeiboAuthenticationHandler"/> to the specified
        ...
        public static AuthenticationBuilder AddWeibo(
            ...
            [NotNull] Action<WeiboAuthenticationOptions> configuration)
        {
            return builder.AddOAuth<WeiboAuthenticationOptions, WeiboAuthenticationHandler>(scheme, name, configuration);
        }
    }
}
