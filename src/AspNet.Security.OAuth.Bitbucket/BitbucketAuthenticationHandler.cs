...
namespace AspNet.Security.OAuth.Bitbucket
{
    ...
    {
        public BitbucketAuthenticationHandler([NotNull] HttpClient client)
            : base(client)
        {
        }
        ...
        protected virtual async Task<string> GetEmailAsync([NotNull] OAuthTokenResponse tokens)
        {
            ...
            return BitbucketAuthenticationHelper.GetEmail(((JArray)JObject.Parse(await response.Content.ReadAsStringAsync())["values"]));
        }
    }
}
