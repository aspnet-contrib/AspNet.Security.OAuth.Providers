...
{
    /// <summary>
    /// Extension methods to add BattleNet authentication capabilities to an HTTP application pipeline.
    /// </summary>
    public static class BattleNetAuthenticationExtensions
    {
        /// <summary>
        /// Adds the <see cref="BattleNetAuthenticationHandler"/> to the specified
        /// <see cref="AuthenticationBuilder"/>, which enables BattleNet authentication capabilities.
        /// </summary>
        ...
        /// <param name="configuration">The delegate used to configure the BattleNet options.</param>
