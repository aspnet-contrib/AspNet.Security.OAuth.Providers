...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    {
        /// <summary>
        /// Adds the <see cref="YahooAuthenticationHandler"/> to the specified
        ...
        public static AuthenticationBuilder AddYahoo(
            ...
            [NotNull] Action<YahooAuthenticationOptions> configuration)
        {
            return builder.AddOAuth<YahooAuthenticationOptions, YahooAuthenticationHandler>(scheme, name, configuration);
        }
    }
}
