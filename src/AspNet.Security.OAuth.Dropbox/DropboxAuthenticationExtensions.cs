...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    {
        /// <summary>
        /// Adds the <see cref="DropboxAuthenticationHandler"/> to the specified
        ...
        public static AuthenticationBuilder AddDropbox(
            ...
            [NotNull] Action<DropboxAuthenticationOptions> configuration)
        {
            return builder.AddOAuth<DropboxAuthenticationOptions, DropboxAuthenticationHandler>(scheme, name, configuration);
        }
    }
}
