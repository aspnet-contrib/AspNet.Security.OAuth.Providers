...
namespace AspNet.Security.OAuth.Untappd
{
    ...
    public static class UntappdAuthenticationHelper
    {
        ...
        public static string GetIdentifier([NotNull] JObject user)
        {
            ...
            return user["user"]?.Value<string>("id");
        }
        ...
        public static string GetUsername([NotNull] JObject user)
        {
            ...
            return user["user"]?.Value<string>("user_name");
        }
        ...
        public static string GetFirstName([NotNull] JObject user)
        {
            ...
            return user["user"]?.Value<string>("first_name");
        }
        ...
        public static string GetLastName([NotNull] JObject user)
        {
            ...
            return user["user"]?.Value<string>("last_name");
        }
        ...
        public static string GetLocation([NotNull] JObject user)
        {
            ...
            return user["user"]?.Value<string>("location");
        }
        ...
        public static string GetUrl([NotNull] JObject user)
        {
            ...
            return user["user"]?.Value<string>("url");
        }
        ...
        public static string GetAvatar([NotNull] JObject user)
        {
            ...
            return user["user"]?.Value<string>("user_avatar");
        }
    }
}
