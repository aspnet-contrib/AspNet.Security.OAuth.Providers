...
namespace AspNet.Security.OAuth.MYOB {
    public class MYOBAuthenticationHandler : OAuthHandler<MYOBAuthenticationOptions> {
        ...
        protected override async Task<AuthenticationTicket> CreateTicketAsync([NotNull] ClaimsIdentity identity,
            ...
            identity.AddOptionalClaim(ClaimTypes.NameIdentifier, MYOBAuthenticationHelper.GetIdentifier(payload), Options.ClaimsIssuer)
                    .AddOptionalClaim(ClaimTypes.Name, MYOBAuthenticationHelper.GetLogin(payload), Options.ClaimsIssuer)
                    .AddOptionalClaim(ClaimTypes.Email, MYOBAuthenticationHelper.GetEmail(payload), Options.ClaimsIssuer)
                    .AddOptionalClaim("urn:github:name", MYOBAuthenticationHelper.GetName(payload), Options.ClaimsIssuer)
                    .AddOptionalClaim("urn:github:url", MYOBAuthenticationHelper.GetLink(payload), Options.ClaimsIssuer);
        ...
        protected virtual async Task<string> GetEmailAsync([NotNull] OAuthTokenResponse tokens) {
            ...
            return MYOBAuthenticationHelper.GetEmail(payload);
        }
    }
}
