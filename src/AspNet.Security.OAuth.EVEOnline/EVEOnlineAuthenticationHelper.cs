...
namespace AspNet.Security.OAuth.EVEOnline
{
    ...
    public static class EVEOnlineAuthenticationHelper
    {
        ...
        public static string GetIdentifier([NotNull] JObject user)
        {
            ...
            return user.Value<string>("CharacterID");
        }
        ...
        public static string GetName([NotNull] JObject user)
        {
            ...
            return user.Value<string>("CharacterName");
        }

        /// <summary>
        /// Gets the access token expiration date.
        /// </summary>
        public static string GetTokenExpiration([NotNull] JObject user)
        {
            if (user == null)
            {
                throw new ArgumentNullException(nameof(user));
            ...
            return user.Value<string>("ExpiresOn");
        }

        /// <summary>
        /// Gets the scopes associated with the access token.
        /// </summary>
        public static string GetTokenScopes([NotNull] JObject user)
        {
            if (user == null)
            {
                throw new ArgumentNullException(nameof(user));
            ...
            return user.Value<string>("Scopes");
        }
    }
}
