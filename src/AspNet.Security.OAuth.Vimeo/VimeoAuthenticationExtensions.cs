...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    {
        /// <summary>
        /// Adds the <see cref="VimeoAuthenticationHandler"/> to the specified
        ...
        public static AuthenticationBuilder AddVimeo(
            ...
            [NotNull] Action<VimeoAuthenticationOptions> configuration)
        {
            return builder.AddOAuth<VimeoAuthenticationOptions, VimeoAuthenticationHandler>(scheme, name, configuration);
        }
    }
}
