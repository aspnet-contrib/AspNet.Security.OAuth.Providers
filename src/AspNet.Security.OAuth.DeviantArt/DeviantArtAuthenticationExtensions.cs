...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    {
        /// <summary>
        /// Adds <see cref="DeviantArtAuthenticationHandler"/> to the specified
        /// <see cref="AuthenticationBuilder"/>, which enables DeviantArt authentication capabilities.
        /// </summary>
        /// <param name="builder">The authentication builder.</param>
        /// <returns>The <see cref="AuthenticationBuilder"/>.</returns>
        public static AuthenticationBuilder AddDeviantArt([NotNull] this AuthenticationBuilder builder)
        {
            return builder.AddDeviantArt(DeviantArtAuthenticationDefaults.AuthenticationScheme, options => { });
        }
        ...
        {
            return builder.AddDeviantArt(DeviantArtAuthenticationDefaults.AuthenticationScheme, configuration);
        }
        ...
        public static AuthenticationBuilder AddDeviantArt(
            ...
            [NotNull] Action<DeviantArtAuthenticationOptions> configuration)
        {
            return builder.AddOAuth<DeviantArtAuthenticationOptions, DeviantArtAuthenticationHandler>(scheme, name, configuration);
        }
    }
}
