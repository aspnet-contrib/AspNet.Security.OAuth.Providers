...
public partial class BungieNetAuthenticationHandler : OAuthHandler<BungieNetAuthenticationOptions>
{
    public BungieNetAuthenticationHandler(
        [NotNull] IOptionsMonitor<BungieNetAuthenticationOptions> options,
        ...
        [NotNull] OAuthTokenResponse tokens)
    {
        ...
        var userInfoEndpoint = string.Format(CultureInfo.InvariantCulture, Options.UserInformationEndpoint, membershipId);
