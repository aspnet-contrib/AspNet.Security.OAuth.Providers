...
namespace Microsoft.AspNetCore.Builder {
    ...
    public static class HealthGraphAuthenticationExtensions {
        /// <summary>
        /// Adds the <see cref="HealthGraphAuthenticationMiddleware"/> middleware to the specified <see cref="IApplicationBuilder"/>, which enables HealthGraph authentication capabilities.
        /// </summary>
