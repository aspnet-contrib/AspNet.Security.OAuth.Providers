...
public static class DocusignAuthenticationConstants
{
    public static class Endpoints
    {
        ...
        public const string DevelopmentAuthorizationEndpoint = "https://account-d.docusign.com/oauth/auth";

        public const string ProductionTokenEndpoint = "https://account.docusign.com/oauth/token";
        public const string DevelopmentTokenEndpoint = "https://account-d.docusign.com/oauth/token";

        public const string ProductionUserInformationEndpoint = "https://account.docusign.com/oauth/userinfo";
        public const string DevelopmentUserInformationEndpoint = "https://account-d.docusign.com/oauth/userinfo";
    }
}
