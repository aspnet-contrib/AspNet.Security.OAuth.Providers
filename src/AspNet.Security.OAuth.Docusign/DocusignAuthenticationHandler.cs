...
public partial class DocusignAuthenticationHandler : OAuthHandler<DocusignAuthenticationOptions>
{
    public DocusignAuthenticationHandler(
        [NotNull] IOptionsMonitor<DocusignAuthenticationOptions> options,
