...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    {
        /// <summary>
        /// Adds the <see cref="WordPressAuthenticationHandler"/> to the specified
        ...
        public static AuthenticationBuilder AddWordPress(
            ...
            [NotNull] Action<WordPressAuthenticationOptions> configuration)
        {
            return builder.AddOAuth<WordPressAuthenticationOptions, WordPressAuthenticationHandler>(scheme, name, configuration);
        }
    }
}
