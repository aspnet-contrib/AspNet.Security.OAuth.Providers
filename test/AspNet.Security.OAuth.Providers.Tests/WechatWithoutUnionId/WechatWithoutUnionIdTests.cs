...
public class WechatWithoutUnionIdTests : OAuthTests<WeixinAuthenticationOptions>
{
    public WechatWithoutUnionIdTests(ITestOutputHelper outputHelper)
    {
